...
! Hamid
! > -------------------------------------------------------------------------
        real(dl)  :: amds = 0._dl ! amplitude of distortion function
        real(dl)  :: zref = 0._dl ! reference location of redshift for distortion function
        real(dl)  :: sigw = 1.d3 ! width of the gaussian distortion function
        real(dl)  :: dzin = 0._dl ! total shift in the ionized fraction
! < -------------------------------------------------------------------------
