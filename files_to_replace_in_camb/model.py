...
class CAMBparams(F2003Class):
    ...
    """
    !> Hamid added 4 new parameters related to the distortion function for ionized fraction:
                amds, zref, sigw, dzin <!
    """
    _fields_ = [
        ...
        ("amds", c_double, "amplitude of distortion function"),
        ("zref", c_double, "reference location of redshift for distortion function"),
        ("sigw", c_double, "width of the Gaussian distortion function"),
        ("dzin", c_double, "total shift in the ionized fraction"),
    ...
    """
    !> Hamid initialized 4 new parameters related to the distortion function for ionized fraction:
                amds, zref, sigw, dzin <!
    """
    def set_cosmology(self, H0: Optional[float] = None, ombh2=0.022, omch2=0.12, omk=0.0,
                      amds=0.2, zref=1.5e3, sigw=1.e3, dzin=0.0,
        ...
        :param setter_H0: if specified, a function to call to set H0 for each iteration to find thetastar. It should be
         ...
         changed for each H0 because it depends explicitly on H0
              ...
              !> Hamid defined the parameters for the python wrapper:
                amds, zref, sigw, dzin <!
        """
